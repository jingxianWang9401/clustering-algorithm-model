# -*- coding: utf-8 -*-
"""
Created on Wed May 20 11:09:46 2020

@author: wangjingxian
"""


#机器学习实战中的k均值聚类和二分k均值聚类还未调通。


from numpy import sqrt,power,shape,mat,zeros,random,mean,nonzero,inf
    ...
    while clusterChanged:
        ...
        for i in range(m):
            ...
            for j in range(k):  # 每个样本点需要与 所有 的中心点作比较
                ...
                if np.any(distJI) < np.any(minDist):
